...
* **Customizable Length**: Set your preferred summary character count
...
2. Go to Settings > AI Post Summary
3. Choose your AI provider (Gemini recommended for free tier)
4. Get your API key (detailed instructions provided)
5. Configure your preferences
6. Start publishing - summaries are generated automatically!
...
Need help? Visit our [support forum](https://wordpress.org/support/plugin/ai-post-summary/) or check our [documentation](https://github.com/aungheinmynn/ai-post-summary).

== Contributing ==

Want to contribute? Visit our [GitHub repository](https://github.com/aungheinmynn/ai-post-summary) to submit issues or pull requests.
